...
insert into tb_goal(id,name,target_amount,current_amount,deadline,userid)values(10,'Nova meta',15000.0,1000.0,'2024-12-31',11);
insert into tb_goal(id,name,target_amount,current_amount,deadline,userid)values(11,'escola',15000.0,1000.0,'2024-12-31',12);
insert into tb_goal(id,name,target_amount,current_amount,deadline,userid)values(13,'viagem',15000.0,1000.0,'2024-12-31',13);
